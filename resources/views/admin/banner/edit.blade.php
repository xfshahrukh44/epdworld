                          ...
                          <form class="form" enctype="multipart/form-data" method="post" action="{{route('admin.banner.update', $banner->id)}}">
                              ...
                              <div class="form-body">
                                  <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="summary-ckeditor">Banner Category</label>

                                                    <select class="form-control select2" name="slider_cat" id="slider_cat" required>

                                                        <option {{ ($banner->slider_cat == 0) ? 'selected' : '' }} value="0">Main</option>
                                                        <option {{ ($banner->slider_cat == 1) ? 'selected' : '' }} value="1">Secondary</option>
