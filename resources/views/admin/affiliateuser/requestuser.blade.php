...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">User Request</h3>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">User Request Info</h4>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('isseller') }}" method="POST">
                                                        ...
                                                        <button class="btn btn-danger btn-sm" type="submit">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true"> </i> Reject
                                                        </button>
                                                    </form>
