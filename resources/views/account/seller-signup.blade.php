                    ...
                    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2">
                        <div class="account_form">
                            ...
                            <form class="affiliateForm" method="POST" action="{{ route('register') }}">
                                ...
                                <p>Thank you for your interest in partnering with <strong>Elite Product
                                        Distributors</strong>!
                                    Please fill out the following form to apply. We will review your application and contact
                                    you with a decision.</p>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="social_media[]" value="tiktok"
                                        id="tiktok">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="social_media[]" value="other"
                                        id="other">
                                    <label class="form-check-label" for="other">Other</label>
                                </div>

                                <div class="form-group mt-2">
                                    <input type="text" class="form-control" name="competing_brands"
                                        placeholder="Are you currently an affiliate for any competing brands?">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="hear_about"
                                        placeholder="How did you hear about our affiliate program?">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="payment_method"
                                        placeholder="Preferred Payment Method for Commission">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" name="about_yourself"
                                        placeholder="Tell us about yourself and why you’d like to join our affiliate program"></textarea>
                                </div>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="agreeTerms">
                                        ...
                                        <a href="#" target="_blank">Affiliate Program Terms, Non-Compete &
                                            Conditions</a> *
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="agree_noncompete"
                                        id="agreeNoncompete" required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="agree_disclosure"
                                        id="agreeDisclosure" required>
                                    <label class="form-check-label" for="agreeDisclosure">
                                        I agree to clearly disclose my affiliate relationship with Elite Product
                                        Distributors in all promotions *
                                    </label>
                                </div>
