...
<div class="col-lg-3 col-md-4">
    <div class="myaccount-tab-menu nav" role="tablist">
        ...
        <a href="{{ route('productlist') }}" class="{{request()->route()->getName() == 'productlist' ? 'active' : ''}}"><i class="fas fa-th"></i>
            My Product</a>

        <a href="{{ route('myorders') }}" class="{{request()->route()->getName() == 'myorders' ? 'active' : ''}}"><i class="fa fa-cart-arrow-down"></i>My Orders</a>
        
        <a href="{{ route('seller-profile', ['slug' => Auth::user()->slug]) }}" class="{{request()->route()->getName() == 'seller-profile' ? 'active' : ''}}"><i class="fa fa-cart-arrow-down"></i>Visit Store</a>
        @endif
