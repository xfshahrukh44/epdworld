                                                ...
                                                <form
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="demo" type="file" class="dropify" name="image"
                                                              {{ ($data->image != '') ? "data-default-file = /$data->image" : ''}} {{ ($data->image == '') ? "required" : ''}} value="{{$data->image}}" required>
        ...
        <div class="repeater-default col-md-12">
            <div data-repeater-list="attribute">
                <div data-repeater-item="" class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-2 text-center mt-2">
                             <label for="bio" class="cursor-pointer">Action</label>
                            <br>
                            <button type="button" class="btn btn-danger att-del" data-repeater-delete=""> <i class="ft-x"></i>
                                Delete</button>
                        </div>
            ...
            <div class="form-group overflow-hidden">
                <div class="">
                    <button type="button" data-repeater-create="" class="btn btn-primary att-add">
