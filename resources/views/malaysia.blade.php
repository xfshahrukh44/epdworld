                ...
                <main id="main" class="site-main">
                    <div class="home-v2-slider">
                        ...
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            <div class="item"
                                 style="background-image: url(https://i0.wp.com/www.additudemag.com/wp-content/uploads/2016/11/Adult_Life_Stories_HowIOvercameDyslexia_Article_11053_11053_different-shoes-3-scaled.jpg);">
                                <div class="container">
                                    <div class="row">
                            ...
                            <div class="item"
                                 style="background-image: url(https://upload.wikimedia.org/wikipedia/commons/b/bf/PhotoStartup_Stock_PhotosProcessed_with_VSCOcamStartup_%2823700141683%29.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                            ...
                            <div class="item"
                                 style="background-image: url(https://seangoca.files.wordpress.com/2019/05/dsc_9196b.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                                            ...
                                            <div class="products owl-carousel home-v2-carousel-tabs products-carousel columns-3">
                                                @php
                                                    $latest_products = \App\Product::whereHas('categorys', function ($q) {
                                                        return $q->where('name', 'Malaysian products');
                                                    })->where('price', '!=', 10.00)->where('id', '!=', 8226)->orderBy('created_at', 'DESC')->take(12)->get();
                                                    $exclude_product_ids = [8226];
                                                @endphp
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/4?name=slippers">
                                            <img src="https://www.wikihow.com/images/c/c7/Make-Shoes-Less-Slippery-Step-14-Version-2.jpg"
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/11?name=heeled-sandals">
                                            <img src="https://i.pinimg.com/originals/69/1a/06/691a0689bc7536cd42ce22a7c7717c2e.jpg"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/8?name=womens-tote-bags">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a7/%E3%83%AB%E3%82%B3%E3%83%83%E3%82%AF_%E3%83%99%E3%83%AB%E3%82%AF%E3%83%AD_%288623650427%29.jpg"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/123?name=dressshoesoxfords">
                                            <img src="https://i.pinimg.com/originals/64/ff/07/64ff077f793d327a5f5a2837613bb4b3.jpg"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/17?name=sports-socks">
                                            <img src="https://cdn.dsmcdn.com/mrktng/seo/temmuz7/jeanslab-1.jpg"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="kitchen-div"
                         style="background-image: url(https://i.pinimg.com/originals/13/38/3e/13383e4825802bd215a14170d3710153.jpg)">
                ...
                <div class="col-lg-6">
                    <div class="motherboard-div"
                         style="background-image: url(https://thesource.com/wp-content/uploads/2015/01/converse-shoes-white-chuck-taylor-all-star-classic-womens-mens-canvas-lo-sneakers-2039-1.jpg)">
                        <div class="kitchen-content">
                            <h6>EXTRA 30% OFF</h6>
