                ...
                <main id="main" class="site-main">
                    <div class="home-v2-slider">
                        ...
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            <div class="item"
                                 style="background-image: url(https://media.npr.org/assets/img/2013/03/06/goodeggsshots_wide-611dec849f3048319708751c57c4111204f7848a.jpg);">
                                <div class="container">
                                    <div class="row">
                            ...
                            <div class="item"
                                 style="background-image: url(https://fonoteka.top/uploads/posts/2021-04/1617809101_33-p-fon-kofe-39.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                            ...
                            <div class="item"
                                 style="background-image: url(https://www.nestleprofessional.co.uk/sites/default/files/2022-07/Header%20%3D%20sustainable-diets-what-you-need-know%20copy.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                    ...
                    <div class="home-v2-ads-block animate-in-view fadeIn animated" data-animation=" animated fadeIn">
                        <div class="ads-block row">
                            <div class="ad col-xs-12 col-sm-6">
                                <div class="media">
                                    <div class="media-left media-middle"><img
                                                src="https://avatars.mds.yandex.net/i?id=1e104d3b90e79512f4ec0df4dc7722b3-6343405-images-thumbs&n=13"
                                                alt=""/>
                                    </div>
                            ...
                            <div class="ad col-xs-12 col-sm-6">
                                <div class="media">
                                    <div class="media-left media-middle"><img
                                                src="https://avatars.mds.yandex.net/i?id=1a9f8b36f387a4b71c47ba1bb471dbedc333b6cd-10448622-images-thumbs&n=13"
                                                alt=""/>
                                    </div>
                                    <div class="media-body media-middle">
                                        <div class="ad-text">
                                            ...
                                            <div class="products owl-carousel home-v2-carousel-tabs products-carousel columns-3">
                                                @php
                                                    $latest_products = \App\Product::whereHas('categorys', function ($q) {
                                                        return $q->where('name', 'Italian products');
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/4?name=slippers">
                                            <img src="https://avatars.mds.yandex.net/i?id=8da417c7d31b4ff6a5d132db44127df3044326be-10470894-images-thumbs&n=13"
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/11?name=heeled-sandals">
                                            <img src="https://avatars.mds.yandex.net/i?id=51b6bc38fd3789734d9b5001829d647b965b3a8f-9858395-images-thumbs&n=13"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/8?name=womens-tote-bags">
                                            <img src="https://avatars.mds.yandex.net/i?id=d43736246f3415dd46abdaa94bacb42947846d9a-8710123-images-thumbs&n=13"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/123?name=dressshoesoxfords">
                                            <img src="https://avatars.mds.yandex.net/i?id=ab93ce71f71bb8d4bd36ee2790c4bd3262908aa8-8806475-images-thumbs&n=13"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/17?name=sports-socks">
                                            <img src="https://avatars.mds.yandex.net/i?id=0a96459f596ec1bfd950a372a80a4b2b-5576459-images-thumbs&n=13"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/25?name=body-stocking">
                                            <img src="https://avatars.mds.yandex.net/i?id=7ea54ce46678edfea7406b9d705a26386ab14986-4558686-images-thumbs&n=13"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
                                ...
                                <div class="mainDiv">
                                    <div class="top-products-cards">
                                        <a href="https://epdworld.com/category-detail/133?name=bikinis--beachwear">
                                            <img src="https://avatars.mds.yandex.net/i?id=ad8daf9c66be6b0aad6919ca9ba0370edce8ddd2-6882373-images-thumbs&n=13"
                                                 class="img-fluid" alt="top1">
                                        </a>
                                    </div>
                                    <div class="top1Content">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="kitchen-div"
                         style="background-image: url(https://avatars.mds.yandex.net/i?id=b57276a8572948e9150a00fcb96a47c205acf46a-5284430-images-thumbs&n=13)">
                ...
                <div class="col-lg-6">
                    <div class="motherboard-div"
                         style="background-image: url(https://avatars.mds.yandex.net/i?id=bba0762b56f1fcfb1c2f509a8ea84e4f284a2a15-9268554-images-thumbs&n=13)">
                        <div class="kitchen-content">
                            <h6>EXTRA 30% OFF</h6>
