            ...
            <main id="main" class="site-main">
                ...
                <div class="shop-tabs">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#grid" role="tab"> <svg version="1.1" id="shop-view-column-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="19px" height="19px" viewBox="0 0 19 19" enable-background="new 0 0 19 19" xml:space="preserve">
                            ...
                            <li class="nav-item list-view">
                                <a class="nav-link" data-toggle="tab" href="#list" role="tab"> <svg viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor" aria-hidden="false" focusable="false"><path d="M906.666667 789.333333a32 32 0 0 1 0 64H117.333333a32 32 0 0 1 0-64h789.333334z m0-309.333333a32 32 0 0 1 0 64H117.333333a32 32 0 0 1 0-64h789.333334z m0-309.333333a32 32 0 0 1 0 64H117.333333a32 32 0 0 1 0-64h789.333334z" data-spm-anchor-id="a2g0o.productlist.0.i107.47c0443foMrWxB"></path></svg></a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-5" role="tab">
                                    <form class="woocommerce-ordering wd-style-underline wd-ordering-mb-icon" method="get">
                                        <select name="orderby" class="orderby" aria-label="Shop order" onchange="filterProduct()">
                                            <option value="" >Filter</option>
                                            <option value="default" <?php if($orderBy == 'default'){echo 'selected';}?>>Default sorting</option>
                                            {{-- <option value="popularity" selected="selected">Sort by popularity</option> --}}
                                            {{-- <option value="rating">Sort by average rating</option> --}}
                                            <option value="latest" <?php if($orderBy == 'latest'){echo 'selected';}?>>Sort by latest</option>
                                            <option value="price-low-high" <?php if($orderBy == 'price-low-high'){echo 'selected';}?>>Sort by price: low to high</option>
                                            <option value="price-high-low" <?php if($orderBy == 'price-high-low'){echo 'selected';}?>>Sort by price: high to low</option>
                                        </select>
                                        <input type="hidden" name="price" value="1">
                                        <input type="hidden" name="per_row" value="2"><input type="hidden" name="per_page" value="18"><input type="hidden" name="shop_view" value="grid"><input type="hidden" name="_pjax" value=".main-page-wrapper">
                                    </form>
                                </a>
                            </li>
                        </ul><!-- Tab panes -->
