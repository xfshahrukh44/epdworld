...
<div id="content" class="site-content" tabindex="-1">
    <div class="container">
        <nav class="woocommerce-breadcrumb"> <a href="{!! route('home') !!}">Home</a>  <span
                class="delimiter"><i class="fa fa-angle-right"></i></span> <a
                href="{{ route('shop') }}">{!! $product_detail->categorys->name !!}</a> <span class="delimiter"><i
            ...
            <main id="main" class="site-main">
                <div class="product">
                        ...
                        <div class="product-images-wrapper"> <span class="onsale">Sale!</span>
                            <div class="images electro-gallery">
                                <div class="thumbnails-single owl-carousel">
                                    ...
                                    @php
                                        $gallery = DB::table('product_imagess')->where('product_id', $product_detail->id)->get();
                                    @endphp
                                        ...
                                        <div class="slecter">
                                            <td class="text-center ">
                                                <div class="qty center">
                                                    ...
                                                    <input id="counter" class="count form-control cartcount " name="qty" value="1">
                                ...
                                <h3>See all buying options</h3>
                                    @foreach($vendor_pro as $pro)
                                        ...
                                        <div class="vendor-sec">
                                            <input type="radio" name="vendor_id" id="vendor_id" value="{{ $pro->user_id }}"/>
                                            <label for="vendor_id">${{ number_format($pro->price, 2) }} By: {{ $user->name }}</label>
                    ...
                    <div class="review-form">
                        <div class="but-rev-box"><h3>Reviews<h3><a class="but-rev">Leave a Review</a>
                        </div>
                        <div class="review-form-box">
                            <form class="form-box" method="POST" action="{{ route('reviewFormSubmit') }}">
                                ...
                                <label>Name</label>
                                <input type="text" class="form-control forms-control" name="name" value="{{ (Auth::check()) ? Auth::user()->name : ''}}" />
                                </div>
                                <!--<div class="form-group">-->
      ...
      <div class="modal-body">
        <form action="{{ route('sell-on-epd') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="stock_inventory" placeholder="Enter Stock Quantity">
          </div>
          <div class="form-group">
