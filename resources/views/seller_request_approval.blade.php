...
<body>
    ...
    <table>
        ...
        <tr>
            <th>Previous Affiliate Marketing Experience</th>
            <td>{{ $affiliate_experience ?? '-' }}</td>
        </tr>

        @if (!empty($affiliate_experience) && $affiliate_experience == 'yes')
            <tr>
                <th>Experience Details (Years)</th>
                <td>{{ $experience_details ?? '-' }}</td>
            </tr>
            <tr>
                <th>Experience Details (Products)</th>
